...
basic idea is to split the multiplication map as $[p] = \frobisog\circ V$
...
known. Although this is reasonably efficient, pulling back $V$ may
...
thus leading to the wrong complexity estimate of $\Omega(\ell
d\log\ell)$ for this phase. We will give more details on interpolation
in Section \ref{sec:C2-AS-FI}.
